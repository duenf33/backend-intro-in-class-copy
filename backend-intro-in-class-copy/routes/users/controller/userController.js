...
module.exports = {
    ...
    login: async (req, res) => {
        ...
        try {
            ...
            if (!logon) {
                res.render("login", { // this will redirect to the login.ejs page and display error message.
                    error: {
                ...
                if (isPasswordTrue) {                    
                    ...
                    res.render("login", { // this will render the login.ejs page and will display this message if there is a problem with either the password or email.
                        error: {
